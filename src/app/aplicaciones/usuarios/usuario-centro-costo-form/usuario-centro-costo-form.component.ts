...
@Component({
  selector: "app-usuario-centro-costo-form",
  templateUrl: "./usuario-centro-costo-form.component.html",
  styleUrls: ["./usuario-centro-costo-form.component.scss"],
})
export class UsuariosCentroCostoFormComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<UsuariosCentroCostoFormComponent>,
