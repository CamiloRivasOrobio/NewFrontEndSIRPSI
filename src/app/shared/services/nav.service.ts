...
export class NavService {
  ...
  public psicologo = "d48926cf-b1f7-4d6c-81ef-f9baaf099b25";
  public adminitrador = "a4d6e0c2-444a-4b94-8351-0faa8cc51c2b";
  public super_admin = "8782edf2-7c4d-4df0-a94d-60e7346ef420";
  constructor() {
    this.onResize();
  ...
  items = new BehaviorSubject<Menu[]>(
    this.role == this.super_admin
      ? this.MENUITEMS_SUPERADMIN
      : this.role == this.adminitrador
      ? this.MENUITEMS_ADMINISTRADOR
      : this.MENUITEMS_PSICOLOGO
  );
}
